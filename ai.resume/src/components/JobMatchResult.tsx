  ...
  const recommendations = [
    {
      ...
      description: 'This skill appeared 3 times in the job description. Consider adding any GraphQL projects or courses.',
      priority: 'high'
    },
    {
      title: 'Highlight Docker knowledge',
      description: 'If you have experience with containerization, make it more prominent in your resume.',
      priority: 'high'
    },
    {
      title: 'Include cloud certifications',
      description: 'AWS certifications would strengthen your application for this role.',
      priority: 'medium'
    },
  ];
