...
export function LandingPageOne() {
  ...
  const features = [
    ...
    },
    {
      ...
      description: 'Upload your resume and get instant ATS compatibility score with detailed improvement recommendations.',
      ...
      <section className="relative overflow-hidden pt-20 pb-28">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-violet-100 dark:bg-violet-900/30 rounded-full mb-6">
            ...
            <span className="text-violet-700 dark:text-violet-300">AI-Powered Career Platform</span>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link to="/signup">
              <Button size="lg" className="bg-gradient-to-r from-violet-600 to-purple-600 hover:from-violet-700 hover:to-purple-700 gap-2 px-8 py-6">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mt-20 max-w-4xl mx-auto">
            {stats.map((stat, index) => (
              <div key={index} className="p-6 rounded-2xl bg-white dark:bg-gray-800 border-2 border-gray-100 dark:border-gray-700 shadow-lg hover:shadow-xl transition-shadow">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-violet-100 dark:bg-violet-900/30 rounded-full mb-4">
              ...
              <span className="text-violet-700 dark:text-violet-300">Powerful Features</span>
            </div>
              ...
              >
                ...
                <CardContent className="p-8 relative">
                  ...
                  <Link to={feature.link}>
                    <Button variant="ghost" className="gap-2 group/btn p-0 h-auto hover:bg-transparent">
                      <span className="text-violet-600 dark:text-violet-400">Try it now</span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-teal-100 dark:bg-teal-900/30 rounded-full mb-4">
              ...
              <span className="text-teal-700 dark:text-teal-300">ATS Compatibility</span>
            </div>
            <h2 className="text-gray-900 dark:text-white mb-4">Beat the Applicant Tracking System</h2>
            <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              75% of resumes are rejected by ATS before reaching human eyes. Our AI-powered ATS Score Checker ensures yours gets through.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
              ...
              <div className="bg-gradient-to-br from-teal-50 to-cyan-50 dark:from-teal-950/30 dark:to-cyan-950/30 rounded-3xl p-8 border-2 border-teal-200 dark:border-teal-800 shadow-xl">
                <div className="mb-6">
                  <div className="flex items-center justify-between mb-2">
                    <h3 className="text-gray-900 dark:text-white">Your ATS Score</h3>
                    <Badge className="bg-gradient-to-r from-teal-600 to-cyan-600">
                      Excellent
                    </Badge>
                  </div>
                  <div className="flex items-end gap-2 mb-4">
                    <span className="text-5xl font-bold text-teal-600 dark:text-teal-400">87</span>
                ...
                <div className="mt-6 p-4 bg-teal-100 dark:bg-teal-900/50 rounded-lg border border-teal-200 dark:border-teal-800">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h4 className="text-gray-900 dark:text-white mb-1">Top Suggestion</h4>
                      <p className="text-gray-700 dark:text-gray-300">
                        Add 3-5 more industry-specific keywords to boost your score to 90+
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h4 className="text-gray-900 dark:text-white mb-2">1. Upload Your Resume</h4>
                    <p className="text-gray-600 dark:text-gray-400">
                      Simply upload your resume in PDF or DOC format. Our AI instantly begins analyzing.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h4 className="text-gray-900 dark:text-white mb-2">2. AI Deep Scan</h4>
                    <p className="text-gray-600 dark:text-gray-400">
                      Our advanced AI analyzes formatting, keywords, structure, and compatibility with major ATS systems.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h4 className="text-gray-900 dark:text-white mb-2">3. Get Detailed Report</h4>
                    <p className="text-gray-600 dark:text-gray-400">
                      Receive a comprehensive score breakdown with specific issues and actionable recommendations.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h4 className="text-gray-900 dark:text-white mb-2">4. Download Optimized Resume</h4>
                    <p className="text-gray-600 dark:text-gray-400">
                      Apply fixes and download your ATS-optimized resume in professional templates.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-8">
                <Link to="/ats-checker">
                  <Button size="lg" className="bg-gradient-to-r from-teal-600 to-cyan-600 hover:from-teal-700 hover:to-cyan-700 gap-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <Card className="border-2 border-blue-100 dark:border-blue-800">
              <CardContent className="p-6 text-center">
                ...
                <h3 className="text-gray-900 dark:text-white mb-2">3x Higher</h3>
                <p className="text-gray-600 dark:text-gray-400">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-white dark:bg-gray-800 rounded-full mb-6 shadow-sm">
                ...
                <span className="text-gray-700 dark:text-gray-300">Why Choose CareerBoost</span>
              </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-4">
                <div className="p-6 bg-white dark:bg-gray-800 rounded-2xl shadow-lg border-2 border-violet-100 dark:border-violet-800">
                  ...
                  <h4 className="text-gray-900 dark:text-white mb-2">Smart Templates</h4>
                  <p className="text-gray-600 dark:text-gray-400">Professional designs that get noticed</p>
                </div>
                <div className="p-6 bg-white dark:bg-gray-800 rounded-2xl shadow-lg border-2 border-blue-100 dark:border-blue-800">
                  ...
                  <h4 className="text-gray-900 dark:text-white mb-2">AI-Powered</h4>
                  <p className="text-gray-600 dark:text-gray-400">Intelligent suggestions and optimization</p>
                </div>
              </div>
              <div className="space-y-4 pt-8">
                <div className="p-6 bg-white dark:bg-gray-800 rounded-2xl shadow-lg border-2 border-green-100 dark:border-green-800">
                  ...
                  <h4 className="text-gray-900 dark:text-white mb-2">Secure & Private</h4>
                  <p className="text-gray-600 dark:text-gray-400">Your data is safe with us</p>
                </div>
                <div className="p-6 bg-white dark:bg-gray-800 rounded-2xl shadow-lg border-2 border-orange-100 dark:border-orange-800">
                  ...
                  <h4 className="text-gray-900 dark:text-white mb-2">Proven Results</h4>
                  <p className="text-gray-600 dark:text-gray-400">85% success rate with users</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-violet-600 via-purple-600 to-pink-600 p-12 md:p-16 text-center">
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <Link to="/signup">
                  <Button size="lg" className="bg-white text-violet-600 hover:bg-violet-50 gap-2 px-8 py-6 shadow-xl">
                    <Sparkles className="w-5 h-5" />
                    Start Free Trial
                  </Button>
                </Link>
